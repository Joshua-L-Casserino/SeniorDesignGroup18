...
void setup() {                                            // set up the hardware
  ...
  timer.setInterval(5000, LCD_Display);
  timer.setInterval(10000, sensorToggle);
  timer.setInterval(60000, minuteCounter);
  timer.setInterval(1200000, Light_Sensor);
  timer.setInterval(30000, water_Level_Sensor);
  timer.setInterval(300000, error_Reporting);
  timer.setInterval(1800000, update_Database);
}
